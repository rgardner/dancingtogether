...
export class MusicPlayerListenerControls extends React.Component<
  IMusicPlayerListenerControlsProps
> {
  ...
  private handleVolumeSliderChange(
    ...
    this.props.onVolumeSliderChange(parseFloat(event.target.value));
  }
}
