...
export function StationAdmin(props: IStationAdminProps) {
    return (
        <div>
            <StationListeners
                            ...
                            <tr key={listener.id}>
                                ...
                                <td>
                                    <button
                                        ...
                                        onClick={props.onListenerDeleteSubmit.bind(null, listener.id)}>
                                        Remove
                            </button>
                                </td>
                            </tr>
...
class InviteListenerForm extends React.Component<IInviteListenerFormProps, IInviteListenerFormState> {
